...
${\OLId{latin-ordinary}{f}}({\OLId{latin-ordinary}{x}},\vec {\OLId{latin-ordinary}{z}})$ \emph{منتظمة} متى كان لكل متتالية أعداد طبيعية
$\vec {\OLId{latin-ordinary}{z}}$ عدد ${\OLId{latin-ordinary}{x}}$ يحقق ${\OLId{latin-ordinary}{f}}({\OLId{latin-ordinary}{x}},\vec {\OLId{latin-ordinary}{z}})={\OLMathNumeral{0}}$. فالدوال المنتظمة، لا غير،
