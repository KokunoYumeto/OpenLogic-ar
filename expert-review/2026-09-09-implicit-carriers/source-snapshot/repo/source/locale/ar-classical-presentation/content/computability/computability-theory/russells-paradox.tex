...
$\{{\OLMathNumeral{0}},{\OLMathNumeral{1}}\}$، المعرفة بـ
  ...
  \begin{cases}
    {\OLMathNumeral{1}} & \text{إذا كانت ${\OLId{latin-ordinary}{f}}$ في مجال ${\OLId{latin-ordinary}{f}}$ وكان ${\OLId{latin-ordinary}{f}}({\OLId{latin-ordinary}{f}}) = {\OLMathNumeral{0}}$} \\
...
\item الحجة القطرية: لتكن ${\OLId{latin-ordinary}{f}}_{\OLMathNumeral{0}}$ و${\OLId{latin-ordinary}{f}}_{\OLMathNumeral{1}}$ و… تعداد الدوال الجزئية
  ...
  \begin{cases}
    {\OLMathNumeral{1}} & \text{إذا كان ${\OLId{latin-ordinary}{f}}_{\OLId{latin-ordinary}{x}}({\OLId{latin-ordinary}{x}})\downarrow = {\OLMathNumeral{0}}$} \\
    {\OLMathNumeral{0}} & \text{في غير ذلك}
  \end{cases}
  \]
