...
\item مجموعة~$\PVar$ !!^a{denumerable} من ال!!{propositional variable}s
  $\Obj p_{\OLMathNumeral{0}}$، $\Obj p_{\OLMathNumeral{1}}$، \dots
...
\begin{defn}[الصيغة]
\ollabel{defn:formulas} تُعرَّف المجموعة~$\Frm[{\OLId{latin-looped}{L}}_{\OLMathNumeral{0}}]$ المؤلفة من
\emph{!!{formula}s} المنطق القضي الحدسي استقرائيًا كما يأتي:
\begin{enumerate}
\item $\lfalse$ !!{formula} ذرية.

\item كل !!{propositional variable}~$\Obj p_{\OLId{latin-ordinary}{i}}$ هي !!{formula} ذرية.
