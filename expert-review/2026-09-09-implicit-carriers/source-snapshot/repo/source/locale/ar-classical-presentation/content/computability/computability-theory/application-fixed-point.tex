...
\begin{cases}
{\OLMathNumeral{0}} & \text{إذا كان ${\OLId{latin-ordinary}{y}}={\OLMathNumeral{0}}$ وكانت $\cfind{{\OLId{latin-ordinary}{f}}({\OLId{latin-ordinary}{e}})}({\OLMathNumeral{0}}) \fdefined = {\OLMathNumeral{0}}$} \\
...
\begin{cases}
{\OLMathNumeral{0}} & \text{إذا كان ${\OLId{latin-ordinary}{y}}={\OLMathNumeral{0}}$ وكانت $\cfind{{\OLId{latin-ordinary}{f}}({\OLId{latin-ordinary}{x}})}({\OLMathNumeral{0}}) \fdefined = {\OLMathNumeral{0}}$} \\
\text{غير معرّفة} & \text{خلاف ذلك.}
\end{cases}
\]
