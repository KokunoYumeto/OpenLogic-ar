...
\path (A) edge [bend left] node {\TMtrans{{\OLId{latin-looped}{A}}}{{\OLId{latin-looped}{A}}}{\TMright}} (B)
(B) edge [loop above] node {\TMtrans{\TMblank}{\TMblank}{\TMright}} (B)
edge [bend left] node {\TMtrans{{\OLId{latin-looped}{A}}}{{\OLId{latin-looped}{A}}}{\TMright}} (A);
\end{tikzpicture}
\end{center}
...
\node[initial,state]         (A)              {${\OLMathNumeral{1}}$};
\node[state]         (B) [right of=A] {${\OLMathNumeral{2}}$};

\path (A) edge [bend left] node {\TMtrans{{\OLMathNumeral{3}}}{{\OLMathNumeral{3}}}{\TMright}} (B)
(B) edge [loop above] node {\TMtrans{{\OLMathNumeral{2}}}{{\OLMathNumeral{2}}}{\TMright}} (B)
edge [bend left] node {\TMtrans{{\OLMathNumeral{3}}}{{\OLMathNumeral{3}}}{\TMright}} (A);
\end{tikzpicture}
\]
