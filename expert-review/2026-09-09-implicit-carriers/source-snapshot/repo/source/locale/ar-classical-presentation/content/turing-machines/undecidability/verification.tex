...
\intertext{مقترنة في $!T({\OLId{latin-looped}{M}},{\OLId{latin-ordinary}{w}})$. وتستلزم ال!!{sentence} الآتية
  (بالتخصيص الكلي، مع $\num{{\OLId{latin-ordinary}{m}}}$ بدل~${\OLId{latin-ordinary}{x}}$ و$\num{{\OLId{latin-ordinary}{n}}}$ بدل~${\OLId{latin-ordinary}{y}}$):}
...
\intertext{ويفيد فرض الاستقراء أن $!T({\OLId{latin-looped}{M}},{\OLId{latin-ordinary}{w}})\Entails !C({\OLId{latin-looped}{M}},{\OLId{latin-ordinary}{w}},{\OLId{latin-ordinary}{n}})$؛ أي}
& \Obj Q_{\OLId{latin-ordinary}{q}}(\num{{\OLId{latin-ordinary}{m}}}, \num{{\OLId{latin-ordinary}{n}}}) \land \Obj S_{\sigma_{\OLMathNumeral{0}}}(\num{{\OLMathNumeral{0}}}, \num{{\OLId{latin-ordinary}{n}}})
\land \dots \land \Obj S_{\sigma_{\OLId{latin-ordinary}{k}}}(\num{{\OLId{latin-ordinary}{k}}}, \num{{\OLId{latin-ordinary}{n}}}) \land \\
& \qquad\lforall[{\OLId{latin-ordinary}{x}}][(\num{{\OLId{latin-ordinary}{k}}} < {\OLId{latin-ordinary}{x}} \lif \Obj S_\TMblank({\OLId{latin-ordinary}{x}}, \num{{\OLId{latin-ordinary}{n}}}))]\\
\intertext{ولما كانت الخانة~${\OLId{latin-ordinary}{m}}$ بعد ${\OLId{latin-ordinary}{n}}$ خطوة تحتوي~$\sigma$، كان
  المقترن المقابل $\Obj S_\sigma(\num{{\OLId{latin-ordinary}{m}}},\num{{\OLId{latin-ordinary}{n}}})$، ولذلك تستلزم هذه}
& \Obj Q_{{\OLId{latin-ordinary}{q}}}(\num{{\OLId{latin-ordinary}{m}}}, \num{{\OLId{latin-ordinary}{n}}}) \land \Obj S_{\sigma}(\num{{\OLId{latin-ordinary}{m}}},
   \num{{\OLId{latin-ordinary}{n}}}).
...
& \qquad (\Obj Q_{{\OLId{latin-ordinary}{q}}'}(\num{{\OLMathNumeral{0}}}, {\OLId{latin-ordinary}{y}}') \land \Obj S_{\sigma'}(\num{{\OLMathNumeral{0}}}, {\OLId{latin-ordinary}{y}}')
  \land !A(\num{{\OLMathNumeral{0}}}, {\OLId{latin-ordinary}{y}})))
\intertext{مقترنة في $!T({\OLId{latin-looped}{M}},{\OLId{latin-ordinary}{w}})$. فإذا كان ${\OLId{latin-ordinary}{m}}>{\OLMathNumeral{0}}$، فليكن ${\OLId{latin-ordinary}{l}}={\OLId{latin-ordinary}{m}}-{\OLMathNumeral{1}}$
  (أي ${\OLId{latin-ordinary}{m}}={\OLId{latin-ordinary}{l}}+{\OLMathNumeral{1}}$). ويستلزم المقترن الأول من ال!!{sentence} السابقة ما يأتي:}
& (\Obj Q_{{\OLId{latin-ordinary}{q}}}(\num{{\OLId{latin-ordinary}{l}}}', \num{{\OLId{latin-ordinary}{n}}}) \land \Obj S_{\sigma}(\num{{\OLId{latin-ordinary}{l}}}', \num{{\OLId{latin-ordinary}{n}}}))
\lif {} \\
& \qquad (\Obj Q_{{\OLId{latin-ordinary}{q}}'}(\num{{\OLId{latin-ordinary}{l}}}, \num{{\OLId{latin-ordinary}{n}}}') \land \Obj S_{\sigma'}(\num{{\OLId{latin-ordinary}{l}}}',
\num{{\OLId{latin-ordinary}{n}}}') \land !A(\num{{\OLId{latin-ordinary}{l}}}', \num{{\OLId{latin-ordinary}{n}}})).
\intertext{وإلا فليكن ${\OLId{latin-ordinary}{l}}={\OLId{latin-ordinary}{m}}={\OLMathNumeral{0}}$، وانظر إلى ال!!{sentence} الآتية التي
...
\Setabs{\tuple{{\OLId{latin-ordinary}{m}}, {\OLId{latin-ordinary}{n}}}}{\begin{array}{ll}\text{بعد بدء ${\OLId{latin-looped}{M}}$ عند~${\OLId{latin-ordinary}{w}}$ ومرور~${\OLId{latin-ordinary}{n}}$ خطوة،}\\ \text{تكون في الحالة ${\OLId{latin-ordinary}{q}}$
  وتمسح الخانة~${\OLId{latin-ordinary}{m}}$}\end{array}} \\
\Assign{\Obj S_\sigma}{{\OLId{latin-looped}{M}}} & = \Setabs{\tuple{{\OLId{latin-ordinary}{m}}, {\OLId{latin-ordinary}{n}}}}{\begin{array}{ll}
\text{بعد بدء ${\OLId{latin-looped}{M}}$ عند~${\OLId{latin-ordinary}{w}}$ ومرور ${\OLId{latin-ordinary}{n}}$ خطوة،}\\ \text{تحتوي الخانة~${\OLId{latin-ordinary}{m}}$ من شريط ${\OLId{latin-looped}{M}}$
