...
لا فواصل~$,$. فإذا كانت~$\sigma$ سابقة، دلّت~$\sigma.n$ على
$\sigma \concat \tuple{n}$؛ فإذا كانت مثلًا
...
إلى عالم، أشارت~$\sigma.n$ إلى عالم يمكن بلوغه من العالم الذي تشير
إليه~$\sigma$.
...
متاحة كذلك،
أي كل سابقة صورتها~$\sigma.n_1.\cdots.n_k$. ونضع الرمز~$\sigma.*$
