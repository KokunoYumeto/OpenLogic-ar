...
\item لتكن $\fn{SeqCode}(d)$ الخاصية العودية البدائية التي تصدق إذا
  وفقط إذا كان~$d$ رمز متتالية منتهية في الترميز المعتمد. ويكون $d$
  عدد غودل لـ!!{derivation} صحيح إذا وفقط إذا كان متتالية غير خالية،
  وكان كل سطر فيها بديهية أو مبررًا بإثبات المقدّم أو بـ\QR. ومن ثم:
  \[
...
العلاقة $\Prf[\Gamma](x,y)$ عودية بدائية؛ وهي تصدق إذا كان $y$ عدد
غودل لـ!!a{sentence}~$!A$، وكان $x$ شفرة !!a{derivation} من~$\emptyset$
...
بدائية بالمعنى الدقيق المبيّن في القضية: يحمل~$x$ شاهد البرهان المغلق
للشرطية المتداخلة، وتحمل المتتالية الوجودية مقدماتها المختارة من~$\Gamma$.
