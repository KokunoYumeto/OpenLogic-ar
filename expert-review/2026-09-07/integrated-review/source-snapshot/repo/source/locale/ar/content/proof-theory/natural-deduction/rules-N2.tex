...
\DisplayProof
\end{tabular}
\caption{قواعد~\Log{N2c} و\Log{N2i}. في~$\Intro{\lforall}$ و
$\Elim{\lexists}$ يجب ألا يظهر~!!{constant}~$a$ في متتالية النتيجة.
وتمثل~$\Gamma_i$ مجموعات من~!!{formula}s الموسومة~$x:!A$. ولا يتضمن
