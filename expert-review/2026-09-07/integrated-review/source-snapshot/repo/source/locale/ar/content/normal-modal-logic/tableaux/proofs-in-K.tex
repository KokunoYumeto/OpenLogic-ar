...
\begin{ex}
  نعطي جدولًا دلاليًا مغلقًا يبيّن أن $\Proves (\Box!A \land \Box!B)
  \lif \Box (!A \land !B)$.
  \begin{oltableau}
...
\iftag{prvDiamond}{
\begin{ex}
  نعطي جدولًا دلاليًا مغلقًا يبيّن أن $\Proves \Diamond(!A \lor !B)
...
\begin{prob}
  أوجد !!{tableau}s مغلقة في~$\Log{K}$ لل!!{formula}s الآتية:
  \begin{enumerate}
