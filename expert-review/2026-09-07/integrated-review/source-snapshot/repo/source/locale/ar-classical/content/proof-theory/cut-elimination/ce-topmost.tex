...
المقدار~$\cheight{\pi}=\pheight{\pi_1}+\pheight{\pi_2}$. وأما
...
أما أساس الاستقراء فهو~$\cheight{\pi}=0$ و$\cutrank{\pi}=0$. ولما كان
...
تكون~$!A$ رئيسة فيهما معًا. وسنبين أن~$\Gamma \Sequent \Delta$ مسلّمة
في كلتا الحالتين، من غير حاجة إلى فرض الاستقراء.

ونقسم الممكنات بحسب كون~$\pi_1$ و$\pi_2$ مسلّمتين أو منتهيتين
...
\Sequent \Delta$ مسلّمة. وعلى هذا تكون $!A$ ذرية وترد في كل من $\Gamma$
...
\RightR{\Contraction} ينتج لنا !!a{proof} لــ$\Gamma \Sequent \Delta$.
...
كان $\lfalse\in\Gamma$، وكانت $\Gamma \Sequent \Delta$ مسلّمة كذلك.
...
\CutCS{}، استنتجت فيه إحدى المقدمتين بقاعدة~$R$ لا تكون !!{formula}
القطع~$!A$ رئيسة فيها، وإنما تكون~!!{formula} أخرى~$!D$ هي الرئيسة. وفي
هذا~!!{proof} تقع \CutCS{} بعد القاعدة~$R$، ورسمه التخطيطي كما يأتي:
\[
\AxiomC{}
\RightLabel{$\pi_1$}
...
بمثالين: أن تكون $!A$ غير رئيسة في آخر الاستدلال لــ$\pi_2$، الذي
...
قطع أقل من~$\pi$. وهذا يعطينا !!a{proof}~$\pi_4$ في \Log{G3c} بغير
...
في آخر الاستدلال لــ$\pi_2$، الذي ينتهي بــ$\RightR{\land}$؛ أما الحالات
الأخرى فنظيرة لها.
...
$\pi_3'$ و~$\pi_4'$ من $\pi_3$ و~$\pi_4$ كذلك بالإضعاف الحافظ للــ
...
$c$ في~$!B(x)$ أو $\Gamma$ أو~$\Delta$. نفرض أن !!{proof}~$\pi$ منتظم،
...
في~$\pi_1'$. ولما كان $c$ لا يرد في~$\pi_2$، فلا يجوز أن يرد في~$t$.
...
تكون فيها $!A$ رئيسة في آخر الاستدلال لــ$\pi_1$، المنتهي بــ
...
رتبة القطع و!!{height} القطع. غير أن !!{proof}~$\pi_1''$---وهو نتيجة تطبيق
