...
بمقدماتها في~\Log{G2i}. فنقول إن مجموعة~$\Gamma'$ من~!!{formula}s
الموسومة \emph{تقابل} المجموعة المتعددة~$\Gamma$ من~!!{formula}s غير
الموسومة، إذا كان، لكل~!!{formula}~$!A$، عدد~!!{element}s~$\Gamma'$ التي
على الصورة~$x:!A$ غير زائد على تعددية~$!A$ في~$\Gamma$.
...
ونسمي قائمة~$S_1$، \dots، $S_n$ من وقائع المتتاليات في~!!{proof}
$\delta$ من~\Log{N2i} \emph{فرعًا} إذا كانت~$S_1$ مسلّمة، وكان~$S_{i+1}$
نتيجة الاستدلال متى كان~$S_i$ مقدمته الكبرى، ولم تكن العقدة الأخيرة
$S_n$ مقدمة كبرى لاستدلال. فالفرع يتعقب المتتاليات هبوطًا في~$\delta$
ابتداء من المسلّمات، ويقف عند المقدمات الصغرى لقواعد~!!{elimination}.
ونسمي \emph{الفرع الرئيس} لـ~$\delta$ كل فرع تكون~$S_n$ فيه المتتالية
...
للمتتالية~$\Gamma \Sequent !A$. فإن خلا~$\delta$ من الاستدلال كان
المسلّمة~$x:!A \Sequent !A$، وأخذنا~$\pi$ المسلّمة المقابلة
...
\begin{enumerate}
  ...
  $\{x:!D \lif !E\}$ و$\Gamma_1$ و$\Gamma_2$. فنلحق ما يلزم من
