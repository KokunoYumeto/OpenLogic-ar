...
وجود عالم~$w$ يحقق~$\mSat{M}{!A}[w]$ يكافئ وجود عالم كذلك يمكن
النفاذ إليه من~$u$. فيجوز، عند دراسة~\Log{S5}، أن نكتفي في وصف
النموذج بمجموعة عوالم وتقويم~$V$. ويتبع ذلك تبسيط قواعد ال!!{tableau}.
فإنما احتجنا، في الحالة العامة، إلى متتاليات الأعداد الصحيحة الموجبة
كي نستدل من البادئات على النفاذ؛ فـ~$\sigma.n$ تسمّي عالمًا ينفذ إليه
