...
$\Prf[\Th{PA}](x,y)$ قابلًا للحساب، فيقبل التمثيل في $\Th{Q}$،
ومن ثم في $\Th{PA}$. ولتكن $\OPrf[\Th{PA}](x,y)$، كما سبق،
الصيغة الممثلة له، ولتكن $\OProv[\Th{PA}](y)$ هي
$\lexists[x][\OPrf[\Th{PA}](x,y)]$.
ومعناها الحدسي أن «$y$ !!{derivable} من بديهيات $\Th{PA}$».
...
$\OProv[\Th{PA}](y)$ تعريفًا دقيقًا، ثم وصف الـ!!{derivation}s
...
والاختيار المعقول للصيغة $\OProv[\Th{PA}](y)$ يحقق كذلك:
\begin{enumerate}
\item[P4.] إذا كان
...
\begin{digress}
وقد ترك غودل التفصيل كما نتركه هنا: عرض في خاتمة بحثه سنة 1931
