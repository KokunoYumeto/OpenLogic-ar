...
\end{center}
\end{figure}
ويصدق الشرط كذلك عند~$w$ إذا خلا نظام الكرات المحيطة بـ$w$ من كرة
...
الكرات في~\olref{fig:contingent} جميع عوالم~$!A$ الأقرب إلى~$u$ من
عوالم~$!B$، ومن ثم~$\mSat{M}{!A \cif !B}[u]$. وأما بعض عوالم~$!A$
الأقرب إلى~$v$ فليست من عوالم~$!B$، ومن ثم
$\mSat/{M}{!A \cif !B}[v]$.
\begin{figure}
\begin{center}
