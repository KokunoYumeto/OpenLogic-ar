...
def completed_generation_admission(receipt, raw, recovery_receipt_sha256=None):
    ...
    One explicit recovery case covers a wrapper that failed its immediate
    descendant check after generation succeeded, then drained those descendants
    in its exception path. The historical FAIL is preserved and identified.
    ...
    recovered = (
        ...
        and receipt.get("failure") == "Completed steps left captured descendants live"
