...
- [Part 048](priority-048.md) — global ranks 471–473; 3 choices
...
- [Part 094](priority-094.md) — global ranks 931–935; 5 choices
...
- [Part 017](complete-017.md) — 15 choices; denumerable … derived textbooks
...
- [Part 027](complete-027.md) — 15 choices; for a fixed set A … formula depth
- [Part 028](complete-028.md) — 15 choices; formula-building functions … function
- [Part 029](complete-029.md) — 15 choices; Function … genuinely na\"ive
- [Part 030](complete-030.md) — 15 choices; graph … Hilbert's Hotel
- [Part 031](complete-031.md) — 15 choices; Hilbert's Hotel; Dedekind infinite; proper subset … If two sets do have elements in common, their intersection is the set of all those: / The intersection of a set with one of its subsets is just the smaller set:
- [Part 032](complete-032.md) — 15 choices; if ℘(PosInt) is enumerable then 2^ω is also enumerable … inductive definition / inductively generated set
- [Part 033](complete-033.md) — 15 choices; inductive step … initial sequent
- [Part 034](complete-034.md) — 15 choices; injection / injective … Intersection
- [Part 035](complete-035.md) — 15 choices; intersection … invertible rule
- [Part 036](complete-036.md) — 15 choices; invoke … isomorphism / elementarily equivalent / automorphism
- [Part 037](complete-037.md) — 15 choices; isomorphism / isomorphic … left inverse
- [Part 038](complete-038.md) — 15 choices; left inverse … logical connective
- [Part 039](complete-039.md) — 15 choices; logical matrix … maximally consistent
- [Part 040](complete-040.md) — 15 choices; maximally consistent … modally closed
- [Part 041](complete-041.md) — 15 choices; model/world … Multiplicative Inverse
- [Part 042](complete-042.md) — 15 choices; multiset … natural numbers
- [Part 043](complete-043.md) — 15 choices; negation … Non-enumerable Sets
- [Part 044](complete-044.md) — 15 choices; non-logical symbol … Open Logic Project
- [Part 045](complete-045.md) — 15 choices; Open Logic Text … ordered field; Completeness Property; least upper bound
- [Part 046](complete-046.md) — 15 choices; ordered fields … overspill
- [Part 047](complete-047.md) — 15 choices; pair … partial functions
- [Part 048](complete-048.md) — 15 choices; Partial Functions … philosophical
- [Part 049](complete-049.md) — 15 choices; Philosophical Reflections … predecessor function
- [Part 050](complete-050.md) — 15 choices; predecessor of the successor of the successor … primitive symbol; defined symbol; informal abbreviation; atomic formula; inductive definition; stage
- [Part 051](complete-051.md) — 15 choices; principal formula … proper subset
- [Part 052](complete-052.md) — 15 choices; proper subset … quantifier
- [Part 053](complete-053.md) — 15 choices; quite … recursive function
- [Part 054](complete-054.md) — 15 choices; redex / contractum / contraction / reduction … reflexivity
- [Part 055](complete-055.md) — 15 choices; Reflexivity … relative product of relations
- [Part 056](complete-056.md) — 15 choices; remixed by … row
- [Part 057](complete-057.md) — 15 choices; rule … schematic proof
- [Part 058](complete-058.md) — 15 choices; schematic proof … sequence
