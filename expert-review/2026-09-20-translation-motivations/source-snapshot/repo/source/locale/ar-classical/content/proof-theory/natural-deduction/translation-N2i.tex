...
متى كان~$\Log{N2c}\ (\Log{N2i}) \Proves \Gamma \Sequent !A$، كان
$\Log{G2c}\ (\Log{G2i}) + \Cut \Proves \Gamma' \Sequent \Delta$؛
و~$\Gamma'$ هنا هي المجموعة المتعددة من~!!{formula}s التي تحصل من
$\Gamma$ بإسقاط الوسوم، و~$\Delta = \{!A\}$ إذا لم تكن~$!A$ هي
$\lfalse$، أما إن كانت إياها فـ~$\Delta = \emptyset$.
\end{prop}

\begin{proof}
ونسلك مرة أخرى الاستقراء على ارتفاع~!!{proof}~$\delta$ للمتتالية
$\Gamma \Sequent !A$. فإن كانت~$\delta$ هي المسلّمة
$x:!A \Sequent !A$، أخذنا~$\pi$ المسلّمة المقابلة
...
\begin{enumerate}
  ...
  \item إذا كانت~$R$ هي~\Intro{\lif} غير أن~$x:!B$ لم يكن موجودًا في سياق
