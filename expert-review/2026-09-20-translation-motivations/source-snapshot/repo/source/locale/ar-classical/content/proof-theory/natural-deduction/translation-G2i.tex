...
مقدّم المتتالية في~\Log{G2i} مجموعة متعددة~$\Gamma$ من~!!{formula}s،
وأما في~\Log{N2i} فهو مجموعة~$\Gamma'$ من الصيغ الموسومة، لا يتكرر فيها
الوسم. ونقول إن~$\Gamma'$ من~!!{formula}s الموسومة \emph{تقابل}
المجموعة المتعددة~$\Gamma$ إذا كان، لكل~!!{formula}~$!A$، عدد
!!{element}s~$\Gamma'$ التي على الصورة~$x : !A$ غير زائد على تعددية~$!A$،
أي عدد نسخ~$!A$، في~$\Gamma$.
...
\begin{proof}
  ...
  $\Gamma \Sequent \Delta$ في~$\Log{G2i}+\Cut$، وجدت~$\Gamma'$ تقابل
  $\Gamma$ ووجد~!!a{proof}~$\delta$ للمتتالية~$\Gamma' \Sequent !C$ في
  \Log{N2i}. ونسلك في ذلك الاستقراء على~$n = \pheight{\pi}$.

  فإن كان~$n = 0$ كان~$\pi$ مسلّمة. فإذا كانت المسلّمة~$\lfalse \Sequent
  \quad$، أخذنا~$\delta$ المسلّمة~$x:\lfalse \Sequent \lfalse$؛ أي إن
  $\Gamma' = \{x:\lfalse\}$ و$!C \ident \lfalse$. وإذا كانت~$\pi$ مسلّمة
  من الصورة $!A \Sequent !A$، كانت~$\delta$ هي $x: !A \Sequent !A$.
  
  وإن كان~$n>0$ كانت آخر~$\pi$ قاعدة~$R$. ويعطينا فرض الاستقراء
  ...
  الوسم~$x$ فوق استدلال يفرغه إلا إذا كان الاستدلال مفرغًا له بالفعل.
  ثم نبين كيف تجمع هذه~!!{proof}s في براهين لمتتالية مناسبة
  $\Gamma' \Sequent !C$، بحسب القاعدة~$R$.
  ...
  \begin{enumerate}
    ...
    $\Gamma'$ تقابل~$\Gamma$ فهي تقابل كذلك~$!A,\Gamma$، لأن عدد الصيغ
    $x:!A$ في~$\Gamma'$ لا يزيد على عدد نسخ~$!A$ في~$\Gamma$، ومن ثم لا
    يزيد كذلك على عدد نسخها في السياق~$!A,\Gamma$.
    ...
    تقابل~$\Gamma'$ المجموعة~$\Gamma$. ينتج لنا~$\delta$ بإتباع
    ...
    المتتالية النهائية لـ~$\delta_2$، فلا يجوز أن يكون~$x:!B$ فعالًا في أي
    ...
    ليكون~$\delta$. وفي الحالة الأولى، وتنبّه إلى أن ظهور~$x:!A$ في المتتالية
