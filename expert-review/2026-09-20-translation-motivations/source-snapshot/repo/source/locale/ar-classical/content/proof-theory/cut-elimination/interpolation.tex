...
في~$!A$، ونضع~$\Lang L(\Gamma) = \bigcup \Setabs{\Lang L(!A)}{!A \in
\Gamma}$. والفرض الجاري في هذا القسم كله أن~!!{formula}s التي نعالجها
خالية من~!!{function}s.
...
\Log{G3c}. فنقسم مقدّم كل متتالية وتاليها قسمين، ونكتب~$\maeh{\Gamma_1}{\Gamma_2} \Sequent
...
\begin{proof}
  لنفرض أن~$\pi \Proves \maeh{\Gamma_1}{\Gamma_2} \Sequent
  ...
  \begin{enumerate}
    ...
    ويعطينا فرض الاستقراء كذلك~$\Lang L(!C_1) \subseteq \Lang L(!A,
    ...
    \end{align*}
    ومؤدى ذلك أن~$!C_1$ صيغة استيفاء لمتتالية نهاية~$\pi$ أيضًا،
    ...
    \]
    وهذا يرجح أن تكون~$!C_1 \lor !C_2$ صيغة الاستيفاء عندئذ.
    ...
    أننا نستطيع استعمال المتتاليتين الباقيتين (1) و(3) كي~!!{prove}
    ...
    $\RightR{\lforall}$ في نهاية~$\pi$.) وعلى هذا تكون~$!C_1$ صيغة
    ...
    \Delta_1, !A(c)) \cap \Lang L(\Gamma_2, \Delta_2)$. فلذلك لا يبقى
    إلا القلق بشأن~$c$: هل يجوز أن تظهر في~$!C_1$؟ لا يمكن. فلو ظهرت
    فيها لكان كل من~$c \in \Lang L(\Gamma_1, \Delta_1, !A(c))$، وهو
    صحيح، و$c \in \Lang L(\Gamma_2, \Delta_2)$. غير أن~$c$ كانت عندئذ
    ...
    وعلى هذا تكون~$!C_1$ صيغة استيفاء مرة أخرى إذا تحقق الشرط
    ...
    ولأننا افترضنا عدم وجود~!!{function}s، فلا يجوز أن يكون الحد~$t$
...
لنفرض أن~$\Gamma$ نظرية (مجموعة~!!{sentence}s) في
...
\begin{lem}[مبرهنة بيث في قابلية التعريف]
  إذا عرّفت~$\Gamma$ العلاقة~$R$ ضمنيًا، عرّفتها صراحة كذلك.
\end{lem}

\begin{proof}
  لنفرض أن~$\Gamma$ تعرّف~$R$ ضمنيًا. لتكن~$R'$ و$\Gamma'$ كما سبق،
...
لنفرض أن~$\Gamma_1$ و$\Gamma_2$ نظريتان متسقتان، وأنه لا توجد~$!A$ في
...
\begin{proof}
  ...
  $\Proves !A, \Gamma_2 \Sequent \quad$. ومن الأخيرة ينتج لنا
