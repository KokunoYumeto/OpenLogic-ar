...
ألا يظهر~!!{constant}~$a$ في النتيجة ولا في فرض مفتوح. وأما
$\Elim{\lexists}$ فيشترط فيه ألا يظهر~$a$ في المقدمة الكبرى ولا في
النتيجة، ولا في فرض مفتوح سوى الفرض~$!A(a)^x$ الذي يبرئه الاستدلال.
