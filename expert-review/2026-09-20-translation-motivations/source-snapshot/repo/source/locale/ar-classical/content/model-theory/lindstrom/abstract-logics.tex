...
\begin{defn}
نسمّي الزوج~$\tuple{L,\models_L}$ \emph{منطقًا مجردًا} إذا كانت $L$ دالة تسند إلى
كل !!{language}~$\Lang{L}$ مجموعة~$L(\Lang{L})$ من الـ!!{sentence}s،
وكانت $\models_L$ علاقة تصل بين الـ!!{structure}s للـ!!{language}~$\Lang{L}$
و!!{element}s~$L(\Lang{L})$. ومن أمثلة ذلك
$\tuple{F,\models}$، وهو منطق الرتبة الأولى المعتاد: فالدالة $F$
...
$\models_L$ بالاستقراء المتبع في منطق الرتبة الأولى. ولهذا وسّعنا
التعريف حتى يتناول، مثلًا، الـ!!{sentence}s التي يشتمل فيها
$\tuple{L,\models_L}$ على اقترانات أو انفصالات غير متناهية الطول، أو على مكممات
سوى $\lexists$ و$\lforall$، نحو «يوجد عدد لا نهائي من~$x$ بحيث
\dots»، بل قد يتناول سوابق كمّية لا يتناهى طولها. وحيث إن
«الـ!!{sentence}s» في $L(\Lang{L})$ ليست مقصورة على !!{sentence}s
...
$\Setabs{\Struct{M}}{\Struct{M} \models_L !E}$. فإن احتيج إلى تعيين
الـ!!{language} في الرمز كتبنا $\Mod[L](L){!E}$. تكون !!{structure}s اثنتان
$\Struct{M}$ و$\Struct{N}$ للغة $\Lang{L}$ \emph{متكافئتين أوليًا في}
$\tuple{L,\models_L}$، ونكتب
$\Struct{M} \elemequiv[L] \Struct{N}$، متى اتفقتا في صدق الـ!!{sentence}s
من $L(\Lang{L})$.
\end{defn}

\begin{defn}
نقول عن المنطق المجرد $\tuple{L,\models_L}$ للـ!!{language}~$\Lang{L}$
...
\item (\emph{خاصية التوسع}) لكل $!E \in L(\Lang{L})$ توجد مجموعة
  ...
  $\Struct{M} \models_L !E$، معرفة مختزل $\Struct{M}$ إلى
...
\item (\emph{خاصية إعادة التسمية}) لا تتبدل العلاقة $\models_L$ بتبديل
...
\item (\emph{الخاصية البوليانية}) ينغلق المنطق المجرد
  $\tuple{L,\models_L}$ تحت الروابط البوليانية؛ وتفصيل ذلك أن لكل
...
\begin{defn}
إذا أخذنا $\tuple{L_1,\models_{L_1}}$ و$\tuple{L_2,\models_{L_2}}$، وهما منطقان
...
\begin{rem}
  أما منطق الرتبة الأولى، وهو المنطق المجرد $\tuple{F,\models}$، فسوي؛
  ...
  !!{subformula}~$\lforall[x][!F]$. ثم إننا إذا أخذنا
  $\tuple{L,\models_L}$ سويًا، وجدنا أن
