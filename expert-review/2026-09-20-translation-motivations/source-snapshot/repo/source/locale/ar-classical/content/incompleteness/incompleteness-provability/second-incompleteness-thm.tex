...
فعدم اتساق $\Th{PA}$ يكافئ $\Th{PA} \Proves \eq[0][1]$.
لذلك نعرّف عبارة الاتساق $\OCon[\Th{PA}]$ بأنها
الـ!!{sentence} $\lnot
\OProv[\Th{PA}](\gn{\eq[0][1]})$، فتأخذ دعوانا صورة المبرهنة
الآتية:
...
لـ$\OCon[\Th{PA}]$، أي على كيفية تمثيل $\OProv[\Th{PA}](y)$.
ولن نحتاج من $\OProv[\Th{PA}](y)$ إلا استيفاء شروط
...
$\OProv[\Th{T}](y)$ صيغة تستوفي شروط !!{derivability}
...
$\Th{Q}$ وتشمل استدلال هيلبرت «التناهي»، أيًّا كان تحديده.
...
في بحثه سنة 1931 أن يكون بعض ما نعدّه تناهيًا خارج الرياضيات التي
