...
\end{derivation}
ومسوّغ ال!!{formula} في السطر~$9$ أنها حالة إحلال من التحصيل المنطقي
\[
...
\begin{proof}
  ...
  \end{derivation}
  إن !!{formula}s في السطرين $6$ و$9$ أمثلة للقضايا الصادقة صدقا
  تحليليا
  \begin{align*}
...
\begin{proof}
  ...
  \end{derivation}
  إن !!{formula}s في السطرين $8$ و$10$ أمثلة للقضيتين الصادقتين صدقا
  تحليليا
  \begin{align*}
  ...
  \end{derivation}
  ويُقرأ السطر الأخير $\lnot \Box p \lif \Diamond\lnot p$؛
  فتلك قراءة الاختصار $\Diamond$ المعرّف بـ$\lnot\Box\lnot$.
  وأما !!{formula} السطر~$5$ فحالة من التحصيل المنطقي
  \[
    (p \lif q) \lif (\lnot q \lif \lnot p).
  \]
  }}{% Box is defined
  ...
  \end{derivation}
  إن !!{formula} في السطر~$4$ مثال للقضية الصادقة صدقا تحليليا
  \begin{align*}
