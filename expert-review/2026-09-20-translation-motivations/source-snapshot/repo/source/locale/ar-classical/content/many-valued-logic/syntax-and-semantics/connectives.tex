...
\begin{defn}
  ...
  $\star$ \emph{رتبة}؛ فإن كانت رتبته~$n$ قيل إنه \emph{ذو~$n$ من
  المواضع}. والرابط ذو الرتبة~$0$ يسمى أيضًا \emph{ثابتًا}؛ وذو
  الرتبة~$1$ يسمى \emph{أحاديًا}، وذو الرتبة~$2$ \emph{ثنائيًا}.
\end{defn}

\begin{ex}
  اللغة القياسية لمنطق القضايا~$\Lang L_0$ مؤلفة من الروابط الآتية،
  ومع كل منها رتبته:
  $\lfalse$~($0$)،
  $\lnot$~($1$)،
  $\land$~($2$)،
  $\lor$~($2$)،
  $\lif$~($2$). وأكثر المنطقات الآتية مبني على هذه اللغة.
  ونرمز بـ~$\Lang L_0^{-}$ إلى جزئها الخالي من الثوابت، المتولد من
