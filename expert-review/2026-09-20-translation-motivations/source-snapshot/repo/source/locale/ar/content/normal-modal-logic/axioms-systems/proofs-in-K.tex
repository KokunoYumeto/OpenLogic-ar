...
للتدرب على البراهين في أصغر نسق جهوي، نبين أن جميع !!{formula}s
الصالحة في الجانب الأيسر من
\olref[syn][sch]{tab:valid-invalidSchemas} يمكن أن تعطى براهين في
\Log{K}.
...
\end{derivation}
لاحظ أن !!{formula} في السطر~$9$ مثال للقضية الصادقة صدقا تحليليا
\[
...
\begin{proof}
  ...
  \end{derivation}
  السطر الأخير هو $\lnot \Box p \lif \Diamond\lnot p$، لأن
  $\Diamond$ معرّف بأنه $\lnot\Box\lnot$. و!!{formula} في السطر~$5$
  مثال للقضية الصادقة صدقا تحليليا
  \[
    (p \lif q) \lif (\lnot q \lif \lnot p).
  \]
  }}{% Box is defined
