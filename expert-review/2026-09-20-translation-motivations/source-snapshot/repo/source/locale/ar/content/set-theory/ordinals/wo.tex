...
!!{element} بحسب~$<$ في~$X$.
  ...
  $\{a\}$ هو~$a$، ولذلك~$a \nless a$. ولإثبات عدم التناظر، لو كان
  $a<b$ و$b<a$ لما كان لأي من~$a$ و$b$ أن يكون أصغريًا في~$\{a,b\}$،
  وهذا محال. وأخيرًا، افترض~$a<b<c$، وليكن~$m$ أصغر !!{element} في
  $\{a,b,c\}$. لا يمكن أن يكون~$m=b$ لأن~$a<b$، ولا أن يكون~$m=c$
  لأن~$b<c$؛ ومن ثم~$m=a$، فيكون~$a\leq c$. وبما أن~$a\neq c$ بحكم
  عدم التناظر، كان~$a<c$، فتكون~$<$ متعدية.
\end{proof}
