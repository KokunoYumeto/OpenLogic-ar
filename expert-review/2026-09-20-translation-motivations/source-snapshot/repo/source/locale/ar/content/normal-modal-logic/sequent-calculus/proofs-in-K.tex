...
\olsection{\usetoken{P}{derivation} تتابعية في \Log{K}}

\iftag{prvBox}{

\begin{ex}
  نعطي !!{derivation} في حساب التتابعيات تبيّن أن
...
\begin{prob}
  أوجد براهين في حساب التتابعيات في~$\Log{K}$ لل!!{formula}s الآتية:
  \begin{enumerate}
