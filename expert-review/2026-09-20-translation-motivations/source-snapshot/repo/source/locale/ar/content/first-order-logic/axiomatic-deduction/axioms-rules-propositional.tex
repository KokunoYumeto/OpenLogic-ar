...
تتألف مجموعة $\PAx$، وهي مجموعة \emph{بديهيات} الروابط القضيّة، من جميع
ال!!{formula}s التي لها إحدى الصور الآتية:
\begin{align}
...
\begin{defn}[قاعدة إثبات المقدَّم]
  إذا ظهرت $!B$ و$!B \lif !A$ بالفعل في !!a{derivation}، فإن $!A$
  خطوة استدلال صحيحة.
\end{defn}

سنختصر قاعدة إثبات المقدَّم بالرمز «\MP».
