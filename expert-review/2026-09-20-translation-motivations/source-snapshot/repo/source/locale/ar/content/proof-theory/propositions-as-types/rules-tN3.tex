...
\begin{table}
\begin{tabular}{@{}c@{}c@{}}
\multicolumn{2}{l}{\textbf{البديهيات:}}\\
\multicolumn{2}{c}{$\Gamma \Sequent x:!A$ إذا كان~$x:!A \in \Gamma$}\\[3ex]
\multicolumn{2}{l}{\textbf{قواعد الاستدلال:}}\\[3ex]
...
\DisplayProof}
\end{tabular}
\caption{قواعد نظام الاستنباط الطبيعي الحدسي القضاياوي الموسوم بالحدود
\Log{tN3ip} المستعمل نظامًا لإسناد الأنماط.}
\ollabel{tab:tN3ip}
\end{table}
