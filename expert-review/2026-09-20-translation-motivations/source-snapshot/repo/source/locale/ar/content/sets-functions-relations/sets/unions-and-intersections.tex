...
\begin{defn}
إذا كانت $A$ مجموعة غير خالية من المجموعات، فإن $\bigcap A$ هي مجموعة الكائنات
...
بحيث ننظر في $A_i$ لكل $i \in I$، يمكننا استعمال اختصار الاتحاد الآتي؛
أما اختصار التقاطع فنشترط فيه أن تكون مجموعة الفهرسة غير خالية:
\begin{align*}
