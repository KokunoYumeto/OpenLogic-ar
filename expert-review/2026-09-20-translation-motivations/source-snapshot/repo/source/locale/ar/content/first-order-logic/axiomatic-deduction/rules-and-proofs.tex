...
ونسمي مجموعة الصيغ التي أُخذت من~$\Gamma$ بموجب البند الأول
\emph{دعم ال!!{derivation}}. وهذا الدعم منتهٍ ولو كانت~$\Gamma$ غير
منتهية. وتُقاس به الشروط المتعلقة بالمقدمات المستعملة، لا بالصيَغ التي لم
يستعملها ال!!{derivation} من~$\Gamma$.
