...
\begin{proof}
  ...
  والثانية القيمة الموافقة لـ$h$. وفي كل خطوة تكرار ننشئ زوجًا جديدًا:
  مركبته الأولى خلف القيمة الحالية لـ$y$، ومركبته الثانية القيمة
  الجديدة لـ$h$ التي تحددها~$g$؛ وبعد انتهاء التكرار
