...
\begin{proof}
  ...
  وسنقيم الدليل على كفاية هذا الصنيع. ولنسمِّ~${\OLId{latin-ordinary}{i}}({\OLId{latin-ordinary}{n}})$ أصغر~${\OLId{latin-ordinary}{i}}$ تتحقق له
  ...
  {\OLId{greek-variable}{Gamma}}_{{\OLId{latin-ordinary}{n}}+{\OLMathNumeral{1}}} = \begin{cases}
    ...
    \text{إذا كان ${\OLId{greek-variable}{Gamma}}_{\OLId{latin-ordinary}{n}} \cup \{!B_{{\OLId{latin-ordinary}{i}}({\OLId{latin-ordinary}{n}})}\} \Proves/ !A$} \\
