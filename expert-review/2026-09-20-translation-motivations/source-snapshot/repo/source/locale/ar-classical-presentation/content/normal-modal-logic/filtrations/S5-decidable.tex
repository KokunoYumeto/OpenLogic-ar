...
\begin{proof}
  ...
  $!A$ واقعة بين~${\OLId{latin-ordinary}{p}}_{\OLMathNumeral{1}}$، \dots،~${\OLId{latin-ordinary}{p}}_{\OLId{latin-ordinary}{k}}$. لكل عدد~${\OLId{latin-ordinary}{n}}$ عدد منتهٍ من
  النماذج الكلية ذات~${\OLId{latin-ordinary}{n}}$ من العوالم ومن تقويمات~${\OLId{latin-ordinary}{p}}_{\OLMathNumeral{1}}$،
  \dots،~${\OLId{latin-ordinary}{p}}_{\OLId{latin-ordinary}{k}}$ عليها. فنُجري تعدادين \emph{بالتوازي}: نولّد البراهين
  على ترتيب منتظم، فنعدّ بذلك مبرهنات~\Log{S5} كلها؛ ونعدّ النماذج
  الكلية المنتهية، مبتدئين بذوات~${\OLMathNumeral{1}}$ من العوالم، ثم~${\OLMathNumeral{2}}$ ثم~$\dots$،
