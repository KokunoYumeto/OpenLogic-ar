...
$\mTrue{{\OLId{latin-ordinary}{p}}}$ حين يكون~${\OLId{latin-ordinary}{w}} \in {\OLId{latin-looped}{V}}({\OLId{latin-ordinary}{p}})$، ونضع~\mFalse{{\OLId{latin-ordinary}{p}}} فيما عدا ذلك.
...
\begin{figure}
  \begin{center}
    \begin{tikzpicture}[modal]
      \node[world] (w1) [label={[align=right]right:\mTrue{{\OLId{latin-ordinary}{p}}}\\ \mFalse{{\OLId{latin-ordinary}{q}}}}]{${\OLId{latin-ordinary}{w}}_{\OLMathNumeral{1}}$};
      \node[world] (w2) [label={[align=right]right:\mTrue{{\OLId{latin-ordinary}{p}}}\\ \mTrue{{\OLId{latin-ordinary}{q}}}},
        above right=of w1]{${\OLId{latin-ordinary}{w}}_{\OLMathNumeral{2}}$};
      \node[world] (w3) [label={[align=right]right:\mFalse{{\OLId{latin-ordinary}{p}}}\\ \mFalse{{\OLId{latin-ordinary}{q}}}},
