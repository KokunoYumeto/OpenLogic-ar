...
\end{tabular}
\end{center}
\caption{هذه قواعد~\Log{Tc}. ويشترط في~$\TRule{\False}{\lforall}$
و$\TRule{\True}{\lexists}$ ألا يقع~!!{constant}~${\OLId{latin-ordinary}{a}}$ فيما تقدمهما من
الفرع؛ أي يكون جديدًا في ذلك الفرع.}
\ollabel{tab:Tc}
\end{table}
