...
\begin{cases}
{\OLMathNumeral{1}} & \text{إذا كانت\/ $\fn{Un}({\OLId{latin-ordinary}{e}}, {\OLId{latin-ordinary}{x}})$ معرفة} \\
...
\begin{cases}
\fn{Un}({\OLId{latin-ordinary}{e}},{\OLId{latin-ordinary}{x}}) & \text{إذا كان ${\OLId{latin-ordinary}{h}}({\OLId{latin-ordinary}{e}},{\OLId{latin-ordinary}{x}}) = {\OLMathNumeral{1}}$} \\
{\OLMathNumeral{0}} & \text{في غير ذلك.}
\end{cases}
\]
...
\begin{cases}
  {\OLMathNumeral{0}}                & \text{إذا كان ${\OLId{latin-ordinary}{h}}({\OLId{latin-ordinary}{x}},{\OLId{latin-ordinary}{x}}) = {\OLMathNumeral{0}}$} \\
