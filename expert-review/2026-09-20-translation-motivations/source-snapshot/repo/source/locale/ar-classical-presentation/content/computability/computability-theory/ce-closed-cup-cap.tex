...
{\OLId{latin-ordinary}{f}}({\OLId{latin-ordinary}{x}}/{\OLMathNumeral{2}}) & \text{إذا كان ${\OLId{latin-ordinary}{x}}$ زوجيًا} \\
{\OLId{latin-ordinary}{g}}(({\OLId{latin-ordinary}{x}}-{\OLMathNumeral{1}})/{\OLMathNumeral{2}}) & \text{إذا كان ${\OLId{latin-ordinary}{x}}$ فرديًا.}
\end{cases}
\]
...
{\OLId{latin-ordinary}{f}}(({\OLId{latin-ordinary}{x}})_{\OLMathNumeral{0}}) & \text{إذا كان ${\OLId{latin-ordinary}{f}}(({\OLId{latin-ordinary}{x}})_{\OLMathNumeral{0}}) = {\OLId{latin-ordinary}{g}}(({\OLId{latin-ordinary}{x}})_{\OLMathNumeral{1}})$} \\
