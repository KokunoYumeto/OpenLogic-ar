...
توجد مجموعة~${\OLId{latin-looped}{A}}$ يكون فيها~$\emptyset \in {\OLId{latin-looped}{A}}$ و
$(\forall {\OLId{latin-ordinary}{x}} \in {\OLId{latin-looped}{A}})\{{\OLId{latin-ordinary}{x}}\} \in {\OLId{latin-looped}{A}}$.
\end{defish}
...
في بناء زرملو~$\emptyset$، وهو نائبنا عن~${\OLMathNumeral{0}}$، لكن التطبيق الحقني يكون
${\OLId{latin-ordinary}{x}} \mapsto \{{\OLId{latin-ordinary}{x}}\}$ بدل~${\OLId{latin-ordinary}{x}} \mapsto {\OLId{latin-ordinary}{x}} \cup \{{\OLId{latin-ordinary}{x}}\}$. وأظهر الفروق أن
زرملو يجعل~${\OLMathNumeral{2}}$ هو~$\{\{\emptyset\}\}$، ونجعله نحن، مع فون نويمان،
$\{\emptyset, \{\emptyset\}\}$.
