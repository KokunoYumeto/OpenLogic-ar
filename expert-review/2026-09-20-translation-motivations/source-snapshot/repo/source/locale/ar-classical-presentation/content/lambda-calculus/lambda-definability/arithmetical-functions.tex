...
\begin{align*}
  ...
  \intertext{تأخذ~$\fn{Succ}$ عددًا~${\OLId{latin-ordinary}{a}}$، فتعطي دالة أخرى هي~$\lambd[fx][{\OLId{latin-ordinary}{f}} ({{\OLId{latin-ordinary}{a}}} {\OLId{latin-ordinary}{f}} {\OLId{latin-ordinary}{x}})]$.
    وليست هذه الدالة في ذات كتابتها عدد تشيرش. لكنها تختزل إلى عدد تشيرش
    متى كان~${\OLId{latin-ordinary}{a}}$ عدد تشيرش. وبيانه:}
   ...
   \intertext{وفي الداخل يقع~$\num{{\OLId{latin-ordinary}{n}}}fx$ موضع اختزال؛ فإن~$\num{{\OLId{latin-ordinary}{n}}}$
     هو $\lambd[fx][{\OLId{latin-ordinary}{f}}^{\OLId{latin-ordinary}{n}}{\OLId{latin-ordinary}{x}}]$. ومن ثم~$\num{{\OLId{latin-ordinary}{n}}}fx \red {\OLId{latin-ordinary}{f}}^{\OLId{latin-ordinary}{n}}{\OLId{latin-ordinary}{x}}$،
...
\intertext{أما الأول فبيانه: تأخذ~$\fn{Add}$ العددين~$ {{\OLId{latin-ordinary}{a}}}$ و$ {{\OLId{latin-ordinary}{b}}}$.
  ثم تعطي دالة تأخذ~${\OLId{latin-ordinary}{f}}$ و${\OLId{latin-ordinary}{x}}$ وتردّ~$af(bfx)$.
  فإذا كان~${\OLId{latin-ordinary}{a}}$ و${\OLId{latin-ordinary}{b}}$ عددي تشيرش~$\num{{\OLId{latin-ordinary}{n}}}$ و$\num{{\OLId{latin-ordinary}{m}}}$،
  اختزل الناتج إلى ${\OLId{latin-ordinary}{f}}^{{\OLId{latin-ordinary}{n}}+{\OLId{latin-ordinary}{m}}}({\OLId{latin-ordinary}{x}})$، أي إلى ${\OLId{latin-ordinary}{f}}^{{\OLId{latin-ordinary}{n}}}({\OLId{latin-ordinary}{f}}^{{\OLId{latin-ordinary}{m}}}({\OLId{latin-ordinary}{x}}))$ نفسه.
  وتفصيل الاختزال:}
...
\intertext{وأما التمثيل الثاني للجمع~$\fn{Add'}$ فطريقه غير ذلك.
  إذ نطبقه في عددي تشيرش~$\num{{\OLId{latin-ordinary}{n}}}$ و$\num{{\OLId{latin-ordinary}{m}}}$ فنحصل على}
\fn{Add}' \num {\OLId{latin-ordinary}{n}} \,\num {\OLId{latin-ordinary}{m}}
& \red \num{{\OLId{latin-ordinary}{n}}}\, \fn{Succ}\, \num{{\OLId{latin-ordinary}{m}}}.
\intertext{والأصل أن~$\num{{\OLId{latin-ordinary}{n}}} {\OLId{latin-ordinary}{f}} {\OLId{latin-ordinary}{x}}$ يختزل دائمًا إلى~${\OLId{latin-ordinary}{f}}^{\OLId{latin-ordinary}{n}}({\OLId{latin-ordinary}{x}})$. فيلزم}
