...
\Assign{+}{{\OLId{latin-looped}{K}}'}({\OLId{latin-ordinary}{x}}, {\OLId{latin-ordinary}{y}}) & =
  \begin{cases}
    {\OLId{latin-ordinary}{x}}+{\OLId{latin-ordinary}{y}}-{\OLMathNumeral{1}} & \text{إذا كان ${\OLId{latin-ordinary}{x}}$ و${\OLId{latin-ordinary}{y}} >{\OLMathNumeral{0}}$}\\
    {\OLMathNumeral{0}} & \text{فيما عدا ذلك}
  \end{cases}\\
  \Assign{\times}{{\OLId{latin-looped}{K}}'}({\OLId{latin-ordinary}{x}}, {\OLId{latin-ordinary}{y}}) & =
  \begin{cases}
    {\OLMathNumeral{1}} & \text{إذا كان ${\OLId{latin-ordinary}{x}} = {\OLMathNumeral{1}}$ أو ${\OLId{latin-ordinary}{y}} = {\OLMathNumeral{1}}$}\\
    xy - {\OLId{latin-ordinary}{x}} - {\OLId{latin-ordinary}{y}} + {\OLMathNumeral{2}} & \text{إذا كان ${\OLId{latin-ordinary}{x}}$ و${\OLId{latin-ordinary}{y}} > {\OLMathNumeral{1}}$}\\
    {\OLMathNumeral{0}} & \text{فيما عدا ذلك}\\
  \end{cases}
\end{align*}
