...
\]
وأما !!^a{tableau} فشجرة متفرعة إلى أسفل تُرتَّب فيها
...
${\OLId{greek-variable}{Gamma}}_{\OLMathNumeral{0}} = \{!B_{\OLMathNumeral{1}}, \dots, !B_{\OLId{latin-ordinary}{n}}\} \subseteq {\OLId{greek-variable}{Gamma}}$ وكان ثمة
!!{tableau} مغلق للفروض
\[
...
تكون المجموعة~${\OLId{greek-variable}{Gamma}}$ غير متسقة في حساب ال!!{tableau} إذا وجد
!!{tableau} مغلق للفروض
\[
\{\sFmla{\True}{!B_{\OLMathNumeral{1}}}, \dots, \sFmla{\True}{!B_{\OLId{latin-ordinary}{n}}}\} 
\]
لبعض~$!B_{\OLId{latin-ordinary}{i}} \in {\OLId{greek-variable}{Gamma}}$.

ظهرت ال!!^{tableau}s في خمسينيات القرن العشرين عند إيفرت بِث وياكو هنتيكا، كلٌّ مستقل عن الآخر، ثم بسطها ريموند سموليان وأشاعها.
