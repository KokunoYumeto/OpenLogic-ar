...
\OProv[\Th{T}]({\OLId{latin-ordinary}{y}})$؛ فهي !!a{sentence} $!G$ تحقق
\[
...
$\OProv[\Th{T}]({\OLId{latin-ordinary}{y}})$ نفسه؟ أي !!a{sentence} $!H$ تحقق
\[
...
الصيغة $!A$، كانت $!A$ صادقة»، أيًّا كانت $!A$.
...
$\OProv[\Th{T}]({\OLId{latin-ordinary}{y}})$ صيغة تحقق الشروط P1--P3 الواردة في
...
\begin{enumerate}
\item نأخذ ${\OLId{latin-looped}{X}}$ الجملة «إذا كانت ${\OLId{latin-looped}{X}}$ صادقة، فإن سانتا كلوز موجود».
\item لنفرض صدق ${\OLId{latin-looped}{X}}$.
\item إذن يصدق مضمونها: إذا صدقت ${\OLId{latin-looped}{X}}$، وجد سانتا كلوز.
\item وبما أننا فرضنا ${\OLId{latin-looped}{X}}$ صادقة، ينتج وجود سانتا كلوز بتطبيق
  قاعدة الفصل على الخطوتين (\OLClassicalDigits{2}) و(\OLClassicalDigits{3}).
\item فاشتققنا (\OLClassicalDigits{4})، وهي وجود سانتا كلوز، من (\OLClassicalDigits{2})، وهي صدق ${\OLId{latin-looped}{X}}$.
  وبالبرهان الشرطي حصلنا على «إذا صدقت ${\OLId{latin-looped}{X}}$، وجد سانتا كلوز».
\item وهذا هو مضمون ${\OLId{latin-looped}{X}}$؛ فقد ثبت صدق ${\OLId{latin-looped}{X}}$.
\item نعود إلى الاستدلال (\OLClassicalDigits{2})--(\OLClassicalDigits{4})، فينتج وجود سانتا كلوز.
\end{enumerate}
...
$\OProv[\Th{T}]({\OLId{latin-ordinary}{y}}) \lif !A$؛ فنقطتها الثابتة تقوم مقام
الجملة ${\OLId{latin-looped}{X}}$ في هذا العرض التقريبي.
\end{explain}

\begin{proof}[برهان \olref{thm:lob}]
لتكن $!A$ !!a{sentence}، ولنفرض أن $\Th{T}$ !!{derive}s
$\OProv[\Th{T}](\gn{!A}) \lif !A$. نعرّف $!B({\OLId{latin-ordinary}{y}})$ بأنها
الـ!!{formula} $\OProv[\Th{T}]({\OLId{latin-ordinary}{y}}) \lif !A$،
...
\begin{align}
  ...
  & \qquad \text{إن~$!D$ نقطة ثابتة لـ$!B({\OLId{latin-ordinary}{y}})$}\notag \\
...
لـ$\OProv[\Th{T}]({\OLId{latin-ordinary}{x}})$، !!{derivable}. فمن
\begin{align*}
  \Th{T} & \Proves \OProv[\Th{T}](\gn{!H}) \liff !H\\
...
\begin{enumerate}
\item من ${\OLId{latin-looped}{T}} \Proves !A$ يلزم ${\OLId{latin-looped}{T}} \Proves \OProv[\Th{T}](\gn{!A})$.
\item ${\OLId{latin-looped}{T}} \Proves !A \lif \OProv[\Th{T}](\gn{!A})$.
\item من ${\OLId{latin-looped}{T}} \Proves \OProv[\Th{T}](\gn{!A})$ يلزم ${\OLId{latin-looped}{T}} \Proves !A$.
\item ${\OLId{latin-looped}{T}} \Proves \OProv[\Th{T}](\gn{!A}) \lif !A$
\end{enumerate}
