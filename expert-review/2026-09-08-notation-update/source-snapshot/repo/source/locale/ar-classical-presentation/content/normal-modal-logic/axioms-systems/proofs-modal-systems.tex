...
وبعد براهين النسق الأدنى، ننظر فيما تزيده البديهيات في النظم
الجهية الأخرى غير~\Log{K}.
  ...
  \begin{enumerate}
    ...
    \item $\Log{KT5} \Proves \Ax{4}$:
      \begin{derivation}
        ...
        مع $\Box!A$ بدلا من ${\OLId{latin-ordinary}{p}}$\\
    ...
    \item $\Log{KB4} \Proves \Ax{5}$:
      \begin{derivation}
        ...
        مع $\Diamond!A$ بدلا من ${\OLId{latin-ordinary}{p}}$\\
    ...
    \item $\Log{KB5} \Proves \Ax{4}$:
      \begin{derivation}
        ...
        $\Box!A$ بدلا من ${\OLId{latin-ordinary}{p}}$ \\
...
وللنسق الكلاسيكي \Log{S5}، كما تبين القضية الآتية، مجموعات
بديهيات مختلفة متكافئة في الناتج. وهذا يوافق ما سبق دلاليًا:
فالتركيبات المذكورة كلها تصف علاقات التكافؤ، كما في
