...
\olref[fil]{defn:filtration} كلاًّ من~${\OLId{latin-looped}{W}}^*$ و${\OLId{latin-looped}{V}}^*$ تعيينًا مباشرًا.
...
\begin{proof}
  أما~${\OLId{latin-looped}{R}}^*$ فقد ضُمِّن تعريفها سائر الشروط، فلا يبقى إلا أن يستلزم~$Ruv$
...
\begin{ex}
  ...
  \begin{figure}
    ...
    \begin{tikzpicture}[modal]
      \node[world] (1) [label=below:\mFalse{p}] {${\OLMathNumeral{1}}$};
      \node[world] (2) [label=below:\mTrue{p}, right=of 1] {${\OLMathNumeral{2}}$};
      \node[world] (3) [label=below:\mFalse{p}, right=of 2] {${\OLMathNumeral{3}}$};
      \node[world] (4) [label=below:\mTrue{p}, right=of 3] {${\OLMathNumeral{4}}$};
    ...
    \begin{tikzpicture}[modal]
      ...
      \node[world] (3) [label=below:\mFalse{p},right=of 2] {$[{\OLMathNumeral{1}}]$};
      \node[world] (4) [label=below:\mTrue{p}, right=of 3] {$[{\OLMathNumeral{2}}]$};
...
\begin{prob}
  ...
  \begin{center}
    \begin{tikzpicture}[modal,
      ...
      \node[world] (0) [label={below:\mTrue{p}\\\mFalse{q}},font=\tiny] {${\OLMathNumeral{0}}$};
