...
\begin{explain}
  ...
  \[
    ...
    \begin{cases}
      {\OLId{latin-ordinary}{x}} + {\OLMathNumeral{1}} &\text{إذا كان ${\OLId{latin-ordinary}{x}} < {\OLId{latin-ordinary}{n}}$}\\
...
\begin{proof}
  ...
  \begin{align*}
    ...
    \begin{cases}
      ...
      {\OLId{latin-ordinary}{n}} &\text{خلاف ذلك،}
    \end{cases} \\
    \tuple{{\OLId{latin-ordinary}{x}},{\OLId{latin-ordinary}{y}}} \in \Assign{<}{{\OLId{latin-looped}{M}}'} &\text{إذا وفقط إذا كان ${\OLId{latin-ordinary}{x}} < {\OLId{latin-ordinary}{y}}$ أو ${\OLId{latin-ordinary}{x}} = {\OLId{latin-ordinary}{y}} = {\OLId{latin-ordinary}{n}}$،}
  \end{align*}
