...
$\lexists[{\OLId{latin-ordinary}{x}}][({\OLId{latin-ordinary}{x}}<{\OLId{latin-ordinary}{t}}\land !A({\OLId{latin-ordinary}{x}}))]$، حيث ${\OLId{latin-ordinary}{t}}$ حد لا يرد فيه المتغير المكمَّم،
...
$\lforall[{\OLId{latin-ordinary}{x}}][({\OLId{latin-ordinary}{x}}<{\OLId{latin-ordinary}{t}}\lif !A({\OLId{latin-ordinary}{x}}))]$، حيث ${\OLId{latin-ordinary}{t}}$ حد لا يرد فيه المتغير المكمَّم،
