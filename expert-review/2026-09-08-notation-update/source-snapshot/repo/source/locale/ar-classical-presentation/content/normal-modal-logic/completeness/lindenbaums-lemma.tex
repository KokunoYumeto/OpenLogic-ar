...
\begin{cases}
  {\OLId{greek-variable}{Delta}}_{\OLId{latin-ordinary}{n}} \cup \{!A_{\OLId{latin-ordinary}{n}}\}, & \text{إذا كانت ${\OLId{greek-variable}{Delta}}_{\OLId{latin-ordinary}{n}} \cup \{!A_{\OLId{latin-ordinary}{n}}\}$
    $\Sigma$-متسقة؛} \\
