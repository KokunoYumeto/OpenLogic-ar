...
\begin{align*}
	...
	\text{إما ${\OLId{greek-variable}{alpha}}_{\OLMathNumeral{2}} \in \beta_{\OLMathNumeral{2}}$،}\\
	& \text{أو كان معًا ${\OLId{greek-variable}{alpha}}_{\OLMathNumeral{2}} = \beta_{\OLMathNumeral{2}}$ و${\OLId{greek-variable}{alpha}}_{\OLMathNumeral{1}} \in \beta_{\OLMathNumeral{1}}$}
\end{align*}
\end{defn}
