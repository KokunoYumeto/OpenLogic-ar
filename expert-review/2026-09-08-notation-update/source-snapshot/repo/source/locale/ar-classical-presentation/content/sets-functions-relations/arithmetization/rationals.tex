...
\intertext{لتعريف ${\OLId{latin-ordinary}{r}} \leq {\OLId{latin-ordinary}{s}}$ على هذه الأعداد النسبية، نستعمل حقيقة أن
${\OLId{latin-ordinary}{r}} \le {\OLId{latin-ordinary}{s}}$ إذا وفقط إذا كان ${\OLId{latin-ordinary}{s}} - {\OLId{latin-ordinary}{r}}$ غير سالب، أي إن ${\OLId{latin-ordinary}{s}} - {\OLId{latin-ordinary}{r}}$ يمكن كتابته
على صورة $\nicefrac{{\OLId{latin-ordinary}{i}}}{{\OLId{latin-ordinary}{j}}}$ حيث يكون ${\OLId{latin-ordinary}{i}}$ غير سالب ويكون ${\OLId{latin-ordinary}{j}}$~موجبًا:}
