...
\item \emph{كونه ابتدائيًّا}: لكل $\OLId{latin-ordinary}{p},\OLId{latin-ordinary}{q} \in \Rat$، من $\OLId{latin-ordinary}{p} < \OLId{latin-ordinary}{q} \in \OLId{greek-variable}{alpha}$ يلزم $\OLId{latin-ordinary}{p} \in \OLId{greek-variable}{alpha}$
...
أو }\OLId{latin-ordinary}{p} < \OLMathNumeral{0}}$. ولا بد، بالطبع، من إثبات أن هذه المجموعة \emph{قطع} حقًّا، وتفصيله مؤخر إلى \olref[check]{sec}.
...
\begin{enumerate}
\item لما كانت $\OLId{latin-looped}{S}$ غير خالية، وجد قطع في $\OLId{latin-looped}{S}$؛ والقطع غير خال، فيلزم $\emptyset \neq \lambda$. ولكون $\OLId{latin-looped}{S}$ مجموعة قطوع نجد $\lambda \subseteq \Rat$. ثم إن لـ$\OLId{latin-looped}{S}$ حدًّا علويًّا، وهو قطع حقيقي؛ فيوجد $\OLId{latin-ordinary}{p} \in
