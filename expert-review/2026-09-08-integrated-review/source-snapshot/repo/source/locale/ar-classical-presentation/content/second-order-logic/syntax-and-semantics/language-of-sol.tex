...
\item مجموعة !!{denumerable} من !!{variable}s العلاقات في الرتبة الثانية،
  لكل رتبة~$\OLId{latin-ordinary}{n}$: $\Obj V_\OLMathNumeral{0}^\OLId{latin-ordinary}{n}$، $\Obj V_\OLMathNumeral{1}^\OLId{latin-ordinary}{n}$، $\Obj V_\OLMathNumeral{2}^\OLId{latin-ordinary}{n}$، \dots
\item ومجموعة !!{denumerable} من !!{variable}s الدوال في الرتبة الثانية،
  لكل رتبة~$\OLId{latin-ordinary}{n}$: $\Obj u_\OLMathNumeral{0}^\OLId{latin-ordinary}{n}$، $\Obj u_\OLMathNumeral{1}^\OLId{latin-ordinary}{n}$، $\Obj u_\OLMathNumeral{2}^\OLId{latin-ordinary}{n}$، \dots
\end{enumerate}
