...
\begin{defn}[!!^{tableau}]
ال!!^a{tableau} للافتراضات~$\sFmla{\OLId{latin-looped}{S}_\OLMathNumeral{1}}{!A_\OLMathNumeral{1}}$، \dots،
$\sFmla{\OLId{latin-looped}{S}_\OLId{latin-ordinary}{n}}{!A_\OLId{latin-ordinary}{n}}$، حيث كل~$\OLId{latin-looped}{S}_\OLId{latin-ordinary}{i}$ إما~$\True$ وإما~$\False$،
شجرة منتهية من ال!!{signed formula}s تستوفي الشرطين الآتيين:
\begin{enumerate}
\item تكون ال!!{signed formula}s العليا وعددها~$\OLId{latin-ordinary}{n}$ في الشجرة هي
  $\sFmla{\OLId{latin-looped}{S}_\OLId{latin-ordinary}{i}}{!A_\OLId{latin-ordinary}{i}}$، واحدة تحت الأخرى.
...
\begin{ex}
  ...
  $\sFmla{\OLId{latin-looped}{S}}{!A}$ فيه. فتُلحق القاعدة !!{signed formula}s، واحدة
  أو أكثر، بنهاية كل فرع يمر بالورود المقصود من~$\sFmla{\OLId{latin-looped}{S}}{!A}$.
  ...
  فمثلًا~$\TRule{\True}{\land} \OLMathNumeral{1}$ يدل على أن ال!!{signed formula}
  في ذلك السطر أُخذت بقاعدة~$\TRule{\True}{\land}$ من
  ال!!{signed formula} في السطر~$\OLMathNumeral{1}$.
