...
\OLId{latin-ordinary}{h}(\vec \OLId{latin-ordinary}{x}, \OLId{latin-ordinary}{y}) & = \begin{cases}
  \OLId{latin-ordinary}{g}(\vec \OLId{latin-ordinary}{x}, \OLId{latin-ordinary}{y}, \OLId{latin-ordinary}{h}(\vec \OLId{latin-ordinary}{x}, \OLId{latin-ordinary}{k}(\vec \OLId{latin-ordinary}{x}, \OLId{latin-ordinary}{y}))) & \text{إذا كان $k(\vec x, y) < y$} \\
