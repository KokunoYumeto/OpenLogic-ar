...
ويسمى~$\OLId{latin-ordinary}{a}$ \emph{المتغير المميَّز} لاستدلال~\Intro{\lforall}.
\footnote{بقيت تسمية «المتغير المميَّز» لأسباب تاريخية، وإن كان~$\OLId{latin-ordinary}{a}$ في هذه القاعدة رمزًا ثابتًا.}
...
ويسمى~$\OLId{latin-ordinary}{a}$ \emph{المتغير المميَّز} لاستدلال
\Elim{\lexists}.
...
\begin{explain}
أما~\Intro{\lexists} و\Elim{\lforall} فلا يلزمهما شرط المتغير المميَّز؛ ويجوز اختيار الحد المغلق~$\OLId{latin-ordinary}{t}$ كيف اتفق.
