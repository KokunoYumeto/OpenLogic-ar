...
إن \emph{$\Log{LK}$-!!{derivation}} لتتابعية~$\OLId{latin-looped}{S}$ شجرة منتهية من
التتابعيات تحقق الشروط الآتية:
\begin{enumerate}
\item التتابعيات العليا في الشجرة تتابعيات ابتدائية.
\item التتابعية السفلى في الشجرة هي~$\OLId{latin-looped}{S}$.
\item كل تتابعية في الشجرة عدا~$\OLId{latin-looped}{S}$ مقدمة لتطبيق صحيح لقاعدة استدلال
  تقع نتيجته تحت تلك التتابعية مباشرةً في الشجرة.
\end{enumerate}
ونسمّي عندئذٍ~$\OLId{latin-looped}{S}$ \emph{التتابعية النهائية} لل!!{derivation}، ونقول
إن~$\OLId{latin-looped}{S}$ \emph{!!{derivable} في $\Log{LK}$} (أو
$\Log{LK}$-!!{derivable}).
\end{defn}
...
فإذا أُريد أن تطابق مقدمتها التتابعية الابتدائية~$!C \Sequent !C$، وجب أن يكون~$\OLId{greek-variable}{Gamma}$
و$\OLId{greek-variable}{Delta}$ كلٌّ منهما~$!C$ وحده. وتكون النتيجة حينئذ
...
\end{prooftree}
كان كل من~$\OLId{greek-variable}{Gamma}$ و$\Pi$ خاليًا، وكانت~$\OLId{greek-variable}{Delta}$ هي~$!C$، وأدى
...
يلزم من هذه المطابقة أن~$\OLId{greek-variable}{Gamma}$ هي
$!C, !D$، وأن~$\OLId{greek-variable}{Delta}$ خالية، وأن~$!A$ هي~$!C$ و$!B$ هي~$!D$.
