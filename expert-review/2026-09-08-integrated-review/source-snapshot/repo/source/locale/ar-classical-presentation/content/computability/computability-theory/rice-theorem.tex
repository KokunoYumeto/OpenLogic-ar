...
\begin{enumerate}
\item $\Setabs{\OLId{latin-ordinary}{x}}{\text{العدد $17$ في مدى $\cfind{x}$}}$
\item $\Setabs{\OLId{latin-ordinary}{x}}{\text{$\cfind{x}$ ثابتة}}$
\item $\Setabs{\OLId{latin-ordinary}{x}}{\text{$\cfind{x}$ كلية}}$
\item $\Setabs{\OLId{latin-ordinary}{x}}{\text{متى كان $y < y'$ وكانت $\cfind{x}(y) \fdefined$،
