...
المتسخة في~$\delta$. نبيّن، بالاستقراء القوي على~$n$، إمكان تحويل~$\delta$
إلى~!!{proof} المنتظم المطلوب~$\delta'$. فإذا كان~$n=0$، كانت كل
استدلالات المتغير المميز في~$\delta$ نظيفة، ومن ثم كان~$\delta$
منتظمًا ولم يبق ما نبرهنه. وإلا فاختر أعلى استدلال متسخ لمتغير مميز، وليكن
...
إلا استبدال المتغير المميز~$c$ بـ$a$. ويكون في البرهان الناتج عدد من
استدلالات المتغير المميز المتسخة أقل من~$n$، فتتبع النتيجة من فرض
الاستقراء القوي.
\end{proof}
