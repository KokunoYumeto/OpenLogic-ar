...
\begin{explain}
  ...
  فقط لكل بادئة. وعلى وجه أدق، تحمل كل بادئة جديدة صيغة أقل عمقًا جهويًا
  من الصيغة التي ولّدتها عند البادئة الأم؛ فلا يجاوز طول سلسلة البادئات
  أكبر عمق جهوي في الصيغ الابتدائية. ولأن عدد الصيغ الجزئية الموقعة عند
  كل بادئة منتهٍ، لا يُولَّد إلا عدد منتهٍ من البادئات الجديدة. ولذلك
