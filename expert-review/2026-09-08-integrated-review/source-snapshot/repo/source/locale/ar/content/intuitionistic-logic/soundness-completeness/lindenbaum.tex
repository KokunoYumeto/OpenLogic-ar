...
\begin{proof}
  ...
  $\Gamma \Proves/ !A$. ولخطوة الاستقراء، ليكن~$n\geq 0$ وافترض أن
  $\Gamma_n \Proves/ !A$؛ وعلينا أن نثبت~$\Gamma_{n+1} \Proves/ !A$. وإذا لم تكن
  ...
  $!B_j\notin\Gamma_n$ و$!C_j\notin\Gamma_n$. ومن المرحلة~$n$ فصاعدًا
  يظل الموضع~$j$ مستوفيًا للشرطين ما دام لم يُنتخب: فالاشتقاق يبقى
  صحيحًا لأن~$\Gamma_n\subseteq\Gamma_m$، وأما~$!B_j$ و$!C_j$ فلا
  ينتميان إلى~$\Gamma^*$ بحسب الفرض. لذلك يكون~$i(m)\leq j$ في كل
  مرحلة~$m\geq n$ تسبق انتخاب~$j$. وإذا انتُخب موضع~$i(m)$، أُضيف
  أحد فصليه، فلا يعود ذلك الموضع مستوفيًا للشرطين في أية مرحلة لاحقة.
  ولما كان عدد المواضع~$i\leq j$ منتهيًا، فلا بد من مرحلة~$m\geq n$
  يكون عندها~$j=i(m)$. ولكن عندئذ إما
