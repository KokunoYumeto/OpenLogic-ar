...
أي مجموعة~$Y$ ترمز، بعلاقة~$R$، مجموعة القوى لـ$X$ إلى~$X$ نفسها.
\end{explain}
...
لترميز مجموعة قوى مجموعة~!!a{denumerable}، أمكننا التعبير عن كون
  مجموعة ما من حجم المتصل بالقول إنها مكافئة عدديًا لمجموعة~$Y$ ترمز
  مجموعة قوى مجموعة~$X$ من الحجم~$\aleph_0$، على أن يكون لكل مجموعة
  جزئية من~$X$ رمز واحد بالضبط في~$Y$؛ وهذا هو شرط التفرّد في الصيغة
  \(\fn{Cont}\) أدناه. أما الترميز غير المتفرّد فلا يعطي إلا حدًا أدنى
  لحجم~$Y$. (وإذا لم يكن المجال كبيرًا
