...
يمكن برهنتها في الحساب مع القاعدة~$R$ بغير استعمال~$R$ كذلك.
\end{defn}
...
$\LeftR{\land}_2$ سنحتاج كذلك إلى القاعدة البنيوية
$\LeftR{\Contraction}$:
\[
\Axiom$!A, !B, \Gamma \fCenter \Delta$
\RightLabel{$\LeftR{\land}_1$}
...
$\pheight{\pi}=\pheight{\pi_1}$، غير أن المساواة ليست لازمة.
...
\begin{proof}
  ...
  $\Gamma\Sequent\Delta',!C,!A$. وبقاعدة~$\RightR{\land}$ ينتج لنا
