...
\begin{proof}
  ...
  $\mSat{M}{!A}[w]$ كان~$\mSat{M^*}{!A}[{[w]}]$ في كل ترشيح
  لـ~$\mModel{M}$ عبر مجموعة~$\Gamma$ من ال!!{formula}s الجزئية
  لـ~$!A$. ولكل !!{formula} عدد منتهٍ من ال!!{formula}s الجزئية،
  فتتناهى~$\Gamma$. ومن~\olref[fin]{prop:filt-are-finite} نحصل على
  $\card{W^*} \le 2^n$، حيث~$n$ عدد ال!!{formula}s في~$\Gamma$.
...
\begin{proof}
  ...
  $w$ في نموذج كلي~$\mModel{M}$، ولنأخذ~$\Gamma$ مؤلفة من~$!A$
  وصيغها الجزئية كلها؛ فهذه~$\Gamma$ منتهية. نأخذ ترشيحًا
  $\mModel{M^*}$ لـ~$\mModel{M}$ عبرها، فيكون~$\mModel{M^*}$ منتهيًا
  بمقتضى~\olref[fin]{prop:filt-are-finite}. ثم تفيد
  \olref[fil]{thm:filtrations} أن~$!A$ تكذب عند~$[w]$ في
  $\mModel{M^*}$. ولا ينقص إلا إثبات أن~$\mModel{M^*}$ كلي.
  فمهما أخذنا~$u$ و$v$ كان~$Ruv$ بالفرض، فتوجب
