...
\olsection{براهين أخرى في \Log{K}}

لنر بعض الأمثلة الأخرى على !!{derivability} في~\Log{K}، مستعملين
هذه المرة الطريقة المبسطة التي عرضت في \olref[der]{sec}.
...
5. &  $\Log{K} \Proves \Box(!A \lif !B) \lif (\Diamond!A \lif \Diamond!B)$ & $\Diamond$ بدلا من $\lnot\Box\lnot$.
\end{derivation}
\end{proof}
...
\begin{proof}
  ...
  \Diamond !B)$ & $\Diamond$ بدلا من $\lnot\Box\lnot$.
  \end{derivation}
\end{proof}
...
\begin{proof}
  \begin{derivation}
    ...
    $\Diamond$ بدلا من $\lnot\Box\lnot$\\
    5. & $\Log{K} \Proves \Diamond!B \lif \Diamond(!A \lor !B)$ & بالطريقة نفسها\\
...
\begin{proof}
  \begin{derivation}
    ...
    \Diamond!B \lif \Diamond!A)$ & $\Diamond$ بدلا من $\lnot\Box\lnot$\\
    7. & $\Log{K} \Proves \Diamond(!A\lor!B) \lif (\Diamond!A \lor \Diamond!B)$ & \PL, 6. \\
  \end{derivation}
\end{proof}

\begin{prob}
  بيّن أن دعاوى !!{derivability} الآتية صحيحة:
  \begin{enumerate}
